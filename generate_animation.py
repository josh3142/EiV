...
from plot import save_animation
...
def run_main(cfg: DictConfig) -> None:
    ...
    save_animation(0, cfg.diffusion.timesteps, samples, trafo,
        interval = cfg.plot.interval,
        cmap = cfg.plot.cmap,
        name = os.path.join(path_imgs, f'animation{checkpoint["step"]}'))
